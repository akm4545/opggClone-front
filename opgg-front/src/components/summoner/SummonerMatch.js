        ...
        <>
            <div className="css-150oaqg e1shm8tx0">
                ...
                <div className="css-3i6n1d ehasqiv3">
                    <div className="stats">
                        <div className="win-lose">20전 11승 9패</div>
                        <div className="kda">
                            <div className="chart">
                                ...
                                <div className="text"><strong>55</strong>%</div>
                            </div>
                            <div className="info">
                                <div className="k-d-a"><span>10.7</span> / <span
                                    className="death">11.0</span> / <span>29.4</span></div>
                                <div className="ratio">3.65:1</div>
                                        ...
                                        <div>
                                            <div className="champion">
                                                <div className="icon"><a href="/champions/viktor" target="_blank"
                                                                         rel="noreferrer"><img
                                                    src="https://opgg-static.akamaized.net/meta/images/lol/champion/Viktor.png?image=c_crop,h_103,w_103,x_9,y_9/q_auto,f_webp,w_96&amp;v=1687251121630"
                                            ...
                                            <div className="kda">
                                                <div className="k-d-a"><span>13</span> / <span
                                                    className="d">8</span> / <span>40</span></div>
                                                <div className="ratio"><span>6.63:1</span> 평점</div>
                                            </div>
                                            <div className="stats">
                                        ...
                                        <div>
                                            <div className="items">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <div className="" style={{position:"relative",}}><img
                                                            src="https://opgg-static.akamaized.net/meta/images/lol/item/3089.png?image=q_auto,f_webp,w_44&amp;v=1687251121630"
                                                            width="22" alt="라바돈의 죽음모자" height="22"/></div>
                                                    </li>
                                                    <li>
                                                        <div className="" style={{position:"relative",}}><img
