...
const OpggFooter = () => {
    return <>
        <footer id="footer" class="css-3pvnm9 enkf8mr1">
            <div>
                <section>
                    <strong class="title">
                        <a href="/">
                    ...
                    <div>
                        ...
                        <nav>
                            <a href="https://op.gg" target="_blank" rel="noreferrer">
                                리그오브레전드
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="리그오브레전드" class="game" height="16"/>
                            </a>
                            <a href="https://op.gg/desktop/" target="_blank" rel="noreferrer">
                                데스크톱<img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="데스크톱" class="game" height="16"/>
                            </a>
                            <a href="https://tft.op.gg" target="_blank" rel="noreferrer">전략적 팀 전투
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="전략적 팀 전투" class="game" height="16"/>
                            </a>
                            <a href="https://valorant.op.gg" target="_blank" rel="noreferrer">
                                발로란트
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="발로란트" class="game" height="16"/>
                            </a>
                            <a href="https://pubg.op.gg" target="_blank" rel="noreferrer">
                                배틀그라운드
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="배틀그라운드" class="game" height="16"/>
                            </a>
                            <a href="https://overwatch.op.gg" target="_blank" rel="noreferrer">
                                오버워치2
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="오버워치2" class="game" height="16"/>
                            </a>
                            <a href="https://er.op.gg" target="_blank" rel="noreferrer">
                                이터널 리턴
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="이터널 리턴" class="game" height="16"/>
                            </a>
                            <a href="https://esports.op.gg" target="_blank" rel="noreferrer">
                                이스포츠
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="이스포츠" class="game" height="16"/>
                            </a>
                            <a href="https://talk.op.gg" target="_blank" rel="noreferrer">
                                톡피지지<img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="톡피지지" class="game" height="16"/>
                            </a>
                            <a href="https://duo.op.gg" target="_blank" rel="noreferrer">
                                Duo
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="Duo" class="game" height="16"/>
                            </a>
                        </nav>
                    </div>
                    <div>
                        ...
                        <nav>
                            <a href="https://play.google.com/store/apps/details?id=gg.op.lol.android&amp;referrer=utm_source%3Dadblock%26utm_medium%3Dbanner" target="_blank" rel="noreferrer">OP.GG Android App
                                <img src="https://s-lol-web.op.gg/images/icon/icon-game.svg?v=1684072072754" width="16" alt="game" class="game" height="16"/>
                            </a>
                    ...
                    <div>
                        ...
                        <nav>
                            ...
                            <a href="https://opggkr.helpscoutdocs.com/collection/121-opgg" target="_blank" rel="noreferrer" class="ko_KR">도움말</a>
